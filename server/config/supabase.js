...
export const supabase = {
  ...
  auth: {
    get signUp() {
      return getSupabaseClient().auth.signUp.bind(getSupabaseClient().auth);
    },
    get signInWithPassword() {
      return getSupabaseClient().auth.signInWithPassword.bind(
    ...
    get resend() {
      return getSupabaseClient().auth.resend.bind(getSupabaseClient().auth);
    },
  },
  from(table) {
